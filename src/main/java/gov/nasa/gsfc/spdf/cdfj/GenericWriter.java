...
public class GenericWriter {
     ...
     * @param   rowMajority a flag indicating the CDF is a row major
     */
     ...
     * @throws CDFException.WriterError if there is an error
     */
...
//          } else {
     ...
     * @return a flag indicating this variable has a depend_0 time variable
     * @throws CDFException.WriterError if there is an error
     */
     ...
     * @param name variable name
     * @param timeType {@link CDFTimeType data type}
     * @throws CDFException.WriterError if there is an error
     */
     ...
     * @param name variable name
     * @param dataType {@link CDFDataType data type}
     ...
     * @param dataType {@link CDFDataType data type}
     * @param  dim    dimensions
     * @param  tname   the given variable's time dependent variable name
     * @throws CDFException.WriterError if there is an error
     */
    public void defineTimeSeries(String name, CDFDataType dataType, int[] dim,
     ...
     * @param  tname   the given variable's time dependent variable name
     * @param  timeType {@link CDFTimeType data type}
     * @param  compressed A flag indicating whether the variable is compressed
     * @throws CDFException.WriterError if there is an error
     */
    public void defineTimeSeries(String name, CDFDataType dataType, int[] dim,
     ...
     * @param recordVariance record variance
     ...
     * the output file.
     * @param need A flag indicating whether to apply md5 checksum to the file
     */
     ...
     * @param fname the output CDF file name
     ...
     * Writes CDF to a file.
     * @param fname the output CDF file name
     * @param overwrite the flag indicating whether to overwrite an exisitng CDF
     * @return A Flag indicating whether the process is sucessful
     * @throws IOException if there is an error
     */
