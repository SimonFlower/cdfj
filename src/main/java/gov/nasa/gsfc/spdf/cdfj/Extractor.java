...
*/
     ...
     * long type not supported in this context - use getRangeForElements1
      * @param thisCDF the CDF 
      * @param var the variable
      * @param istart  the starting points
      * @param iend  the ending points
      * @return a 2-D double data object
    ...
    /** good for rank 1
      * @param var the variable
      * @param idx  the indices to be checked
      * @return a flag indicating whether all indices are within the valid 1-D element 
     */
    ...
    /**
      ...
      * @param istart  the starting points
      * @param iend  the ending points
      * @param ielement  the element number in a 1D array
    ...
    /**
      ...
      * @param idx  the start/end element in the 1D array
      * @return a data object
      * @throws Throwable if an error occurs
     */
...
*/
    ...
    /**
      ...
      * terminated string
      * Get 1D series data from a variable in a CDF
      * @param bv the bute buffer 
    ...
    /**
      * Get 0D series of string data from a variable in a CDF
      * @param thisCDF the CDF 
      * @param var the variable
      * @return a 1-D string array
      */
    ...
    /**
      * Get 1D series string data from a variable in a CDF
      * @param thisCDF the CDF 
      * @param var the variable
     ...
     * returns range of blocks containing the range of records (start, end).
      * @param locations A vector of block locations for check
      * @param recordVariance the flag of variable record variance
      * @param start  the starting record
      * @param end  the ending record
      * @return a 1-D int array
     */
    ...
    /**
      * Get 3D series data from a variable in a CDF
      * @param thisCDF the CDF 
      * @param var the variable
      * @return a 4-D double array
      * @throws Throwable if an error occurs
      */
    ...
    /**
      * Retrun 3D Point data from a variable in a CDF
      * @param thisCDF the CDF 
      * @param var the variable
      * @param pt  the start/stop points
    ...
    /**
      * Return 1D point data from a variable in a CDF
      * @param thisCDF the CDF 
      * @param var the variable
      * @param pt  the start/stop points
